              ...
              {filteredProducts.map((p, idx) => {
                return (
                  <motion.div 
                    ...
                    layout="position"
                    className="card-glass group flex flex-col justify-between rounded-xl sm:rounded-[18px] p-3 sm:p-7 hover:border-accent/15 hover:shadow-md transition-all duration-300"
                  >
                    <div>
